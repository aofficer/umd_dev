...
$firstArr = db_query($sql, array(':nid' => $nid))->fetchAll();
...
$bill= number_format(array_sum($bArr),2);
 ...
 if($total)print "<h2>Total $".$total."</h2><br>";
//print_r($userinfo);
?>
...
<div class="col-md-8">
 ...
 print $userinfo->field_first_name['und'][0]['value']." ".$userinfo->field_last_name['und'][0]['value']
 ?>
...
<div class="col-md-8 ">
  <label for="edit-submitted-contact-info-mail">Email<span class="form-required" title="This field is required.">*</span></label>
 <input class="form-control form-text required" type="text" id="mail" name="submitted[mail]" value="
 <?php print $userinfo->mail ?>" size="60" maxlength="128" readonly>
</div>

<div class="col-md-4">
  <label for="edit-submitted-contact-info-ceil">Ceiling Code<span class="form-required" title="This field is required.">*</span></label>
 <input class="form-control form-text required" type="text" id="edit-submitted-contact-info-ceil" name="submitted[ceil]" value="
  <?php print $userinfo->field_ceiling_code['und'][0]['value']?>
 " size="60" maxlength="128" readonly>
</div>
  </div>
  </fieldset>
...
<fieldset class="webform-component-fieldset webform-component--event-info panel panel-default form-wrapper">
      ...
      <div class="col-md-8" id="outputDiv"></div>
          <div class="panel-body">
...
<?php 
$grpArr = $node->field_group_member['und'];
foreach($grpArr as $g){   ?>
<div class="col-md-4 ">
  <label for="edit-submitted-contact-info-groupmem">Group Member<span class="form-required" ></span></label>
 <input class="form-control form-text" type="text" id="groupmem" name="submitted[groupmem]" value="
 <?php print_r($g['value']); ?>" size="60" maxlength="10" readonly>
</div>
<?php } ?>   
</div>
</fieldset>
...
if($reim) print"<h3 style='color:red'>Reimbursable: $".$reim."</h3>";print views_embed_view($viewName,$displayName1,$nid); 

if($bill) print"<h3 style='color:red'>Paid by Tcard/Pcard: $".$bill."</h3>";print views_embed_view($viewName,$displayName2,$nid);
?>
