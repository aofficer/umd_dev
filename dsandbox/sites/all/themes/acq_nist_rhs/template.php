 ...
 */
function acq_nist_rhs_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'theme-markup-2';
  $vars['classes_array'][] = _acq_nist_rhs_get_layout();
}

/**
 * Implements hook_html_head_alter().
 */
function acq_nist_rhs_html_head_alter(&$head_elements) {
...
function acq_nist_rhs_preprocess_page(&$variables) {
  ...
  $layoutClass = _acq_nist_rhs_get_layout();
 ...
 */
function acq_nist_rhs_preprocess_block(&$vars) {
 ...
 */
function _acq_nist_rhs_variable_get($key, $default) {
  global $theme;
 ...
 */
function _acq_nist_rhs_get_layout() {
  $layout_patterns = _acq_nist_rhs_variable_get('layout', array('<global>' => 'body-layout-fixed-abc'));
 ...
 */
function acq_nist_rhs_node_view_alter(&$build) {
...
function acq_nist_rhs_preprocess_forum_topic_list(&$vars) {
 ...
 */
function acq_nist_rhs_preprocess_comment_wrapper(&$vars) {
 ...
 */
function acq_nist_rhs_preprocess_media_gallery_license(&$vars) {

}

function acq_nist_rhs_preprocess_kewlogin_welcome(&$vars) {
  //drupal_set_message(printr($vars));
}

function acq_nist_rhs_preprocess_node(&$vars) {
  $node = $vars['node'];
  //printr($vars);
...
function acq_nist_rhs_preprocess_webform_submission_page(&$vars) {
...
function acq_nist_rhs_facetapi_title(&$vars) {
